...
<head>
    ...
    <title>Nafuumall Admin! | Add SubCategory </title>
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Create/Add New SubCategory</h3>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add SubCategory <small>Fill all required fields</small></h2>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class=" item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                        for="sub_name">New Sub-Category Name<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 ">
                                                        <input type="text" id="sub_name" name="sub_name"
                                                            required="required" class="form-control ">
                                                            <input type="hidden" id="sub_add" name="sub_add" value ="1">
                                                    </div>
                                                </div>
                                                <div class="item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                        for="seller_id">Category<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 ">
                                                        <select class="form-control" name="cat_id" required>
                                                            <option value="" selected>Choose Parent/Main Category
                                                            </option>
                                                            <?php
