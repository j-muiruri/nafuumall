...
<div id="mainBody">
	...
	<h3 align="center">Seller Point Registration</h3>	
	<div class="well">
...
$emailCheck = mysqli_query($server, "SELECT * FROM `seller_details` WHERE email = '$email'  ");
...
$insert =mysqli_query($server, "INSERT INTO seller_details(`name`, `email`, `password`, `date_of_birth`, `date`, `time`) 		  
        VALUES ('$name','$email','$password','$date_of_birth','$date','$time')") or 
			...
			echo'		<button type="button" class="close" data-dismiss="alert">×</button>';
			echo'		You have successfully Registered.  <strong><a href="sp_login.php" role="button" data-toggle="modal">Log in</a></strong> ';
	 		echo'		</div>';
	 			}
	 			else
				{
