...
<!-- Sidebar end=============================================== -->
	...
	<h3> Control Panel</h3>	
	<hr class="soft"/>
	<a class="btn" href="postitem.php?categories">Categories</a>
	<a class="btn" href="postitem.php?sub_categories">Sub-Categories</a>
	<a class="btn" href="postitem.php?add_item">Items Available</a>
	<a class="btn" href="sp_orders.php">Orders</a>
	<hr class="soft"/>
